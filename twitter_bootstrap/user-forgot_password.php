            ...
            <div class="contact well">
                 <form action="<?php echo osc_base_url(true); ?>" method="post" onsubmit="return doSubmit() ;">
                    ...
                    <fieldset>
                        ...
                        <div class="clearfix">
                            <label for="new_password"><?php _e('New pasword', 'twitter_bootstrap') ; ?></label>
                            <div class="input">
                                <input class="large" type="password" value="" name="new_password" id="new_password">
                            </div>
                        </div>
                        <div class="clearfix">
                            <label for="new_password2"><?php _e('Repeat new pasword', 'twitter_bootstrap') ; ?></label>
                            <div class="input">
                                <input class="large" type="password" value="" name="new_password2" id="new_password2">
                            </div>
                        </div>
                        <div class="actions">
                            <button class="btn" type="submit"><?php _e('Change password', 'twitter_bootstrap') ; ?></button>
                        </div>
                    </fieldset>
                 </form>
            </div>
