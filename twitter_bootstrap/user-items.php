        ...
        <div class="container user">
            <div class="row">
                <div class="span16 columns">
                    ...
                    <h2><?php _e('Your items', 'twitter_bootstrap') ; ?></h2>
                </div>
            </div>
            <?php if(osc_count_items() == 0) { ?>
            <div class="row">
                <div class="span16 columns">
                    <h4><?php _e("You don't have any items yet", 'twitter_bootstrap') ; ?></h4>
                </div>
            </div>
            <?php } else { ?>
                ...
                <div class="row">
                    <div class="span16 columns">
                        ...
                        <p>
                            <strong><a href="<?php echo osc_item_edit_url(); ?>"><?php _e('Edit', 'twitter_bootstrap') ; ?></a></strong>
                            &middot;
                            <a class="delete" onclick="javascript:return confirm('<?php _e('This action can not be undone. Are you sure you want to continue?', 'twitter_bootstrap') ; ?>')" href="<?php echo osc_item_delete_url() ; ?>" ><?php _e('Delete', 'twitter_bootstrap') ; ?></a>
                            <?php if( osc_item_is_inactive() ) { ?>
                            &middot;
                            <a href="<?php echo osc_item_activate_url() ; ?>" ><?php _e('Activate', 'twitter_bootstrap') ; ?></a>
                            <?php } ?>
                        </p>
                    </div>
                </div>
