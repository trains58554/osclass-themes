        ...
        <div class="container">
            ...
            <div class="contact well">
                <form name="register" id="register" action="<?php echo osc_base_url(true) ; ?>" method="post" onsubmit="return doSubmit();" >
                    ...
                    <fieldset>
                        <legend><?php _e('Register an account for free', 'twitter_bootstrap') ; ?></legend>
                        <div class="clearfix">
                        ...
                        <div class="clearfix">
                            <label for="s_password"><?php _e('Password', 'twitter_bootstrap') ; ?> *</label>
                            <div class="input">
                                <input class="xlarge" type="password" value="" name="s_password" id="s_password">
                            </div>
                        </div>
                        <div class="clearfix">
                            <label for="s_password2"><?php _e('Re-type password', 'twitter_bootstrap') ; ?> *</label>
                            <div class="input">
                                <input class="xlarge" type="password" value="" name="s_password2" id="s_password2">
                            </div>
                        </div>
                        <div class="clearfix">
                            <label for="s_email"><?php _e('E-mail', 'twitter_bootstrap') ; ?> *</label>
                            <div class="input">
                        ...
                        <div class="actions">
                            ...
                            <button class="btn" type="submit"><?php _e('Create', 'twitter_bootstrap') ; ?></button>
                        </div>
                        <div class="clearfix">
                            <div class="input">
                                <a href="<?php echo osc_user_login_url() ; ?>"><?php _e("Login", 'twitter_bootstrap') ; ?></a> &middot; <a href="<?php echo osc_recover_user_password_url() ; ?>"><?php _e("Forgot password?", 'twitter_bootstrap') ; ?></a>
                            </div>
                        </div>
                    </fieldset>
                </form>
