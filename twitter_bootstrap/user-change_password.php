            ...
            <div class="row">
                <div class="span16 columns">
                    ...
                    <form action="<?php echo osc_base_url(true) ; ?>" method="post" onsubmit="return doSubmit() ;">
                        ...
                        <fieldset>
                            <legend><?php _e('Change your password', 'twitter_bootstrap') ; ?></legend>
                            <div class="clearfix">
                                <label for="password"><?php _e('Current password', 'twitter_bootstrap') ; ?></label>
                                <div class="input">
                                    <input class="xlarge" type="password" value="" name="password" id="password">
                                </div>
                            </div>
                            <div class="clearfix">
                                <label for="new_password"><?php _e('New password', 'twitter_bootstrap') ; ?></label>
                                <div class="input">
                                    <input class="xlarge" type="password" value="" name="new_password" id="new_password">
                                </div>
                            </div>
                            <div class="clearfix">
                                <label for="new_password2"><?php _e('Repeat new password', 'twitter_bootstrap') ; ?></label>
                                <div class="input">
